        ...
        <>
            <div className="w-[90%] mt-6 md:w-[40%] m-auto">
                <div className="flex flex-col  justify-center">
                    ...
                    <form action="" className='flex flex-col gap-5 mt-5' onSubmit={handleSignIn}>
                        ...
                        <div className="btnGroup ">
                            <button className="btn text-white w-full px-3 py-3 rounded-md bg-blue-600 font-medium text-base" >Sign In</button>
                            <p className='text-white mt-2 text-sm py-2'>Don't have Account?
